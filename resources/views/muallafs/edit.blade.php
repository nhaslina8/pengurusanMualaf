<x-app-layout>
    <div class="bg-white shadow rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-indigo-50">
            <h2 class="text-2xl font-bold text-gray-900">Kemaskini Muallaf</h2>
        ...
        <form action="{{ route('muallafs.update', $muallaf->Id) }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="flex gap-4 mt-8 pt-6 border-t border-gray-200">
                ...
                <a href="{{ route('muallafs.show', $muallaf->Id) }}" class="inline-flex items-center px-6 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-md font-medium transition">
                    Batal
                </a>
            </div>
        </form>
